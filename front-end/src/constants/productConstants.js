...
export const PRODUCT_CATEGORY_LIST_UPDATE = 'PRODUCT_CATEGORY_LIST_UPDATE'

export const PRODUCT_LIST_WITH_CATEGORY_REQUEST =
  'PRODUCT_LIST_WITH_CATEGORY_REQUEST'
export const PRODUCT_LIST_WITH_CATEGORY_SUCCESS =
  'PRODUCT_LIST_WITH_CATEGORY_SUCCESS'
export const PRODUCT_LIST_WITH_CATEGORY_FAIL = 'PRODUCT_LIST_WITH_CATEGORY_FAIL'

export const PRODUCT_LIST_VIP_FAIL = 'PRODUCT_LIST_VIP_FAIL'
export const PRODUCT_LIST_VIP_REQUEST = 'PRODUCT_LIST_VIP_REQUEST'
export const PRODUCT_LIST_VIP_SUCCESS = 'PRODUCT_LIST_VIP_SUCCESS'
